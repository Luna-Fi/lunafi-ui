...
import { ButtonOutline, Props } from '.';
declare type ComponentType = typeof ButtonOutline;
declare const component: ComponentMeta<ComponentType>;
export default component;
export declare const Primary: React.ComponentStory<import("react").ForwardRefExoticComponent<Props & import("react").RefAttributes<HTMLAnchorElement | HTMLButtonElement>>>;
export declare const Secondary: React.ComponentStory<import("react").ForwardRefExoticComponent<Props & import("react").RefAttributes<HTMLAnchorElement | HTMLButtonElement>>>;
